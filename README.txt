...
a persistence unit "pruebaWeb2PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "pruebaWeb2/pom.xml":
...
artifact ("pruebaWeb2.war") is already built. You can build
